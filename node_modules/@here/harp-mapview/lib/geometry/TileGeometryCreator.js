...
const TextElementBuilder_1 = require("../text/TextElementBuilder");
const AddGroundPlane_1 = require("./AddGroundPlane");
        ...
        if (decodedTile.textPathGeometries !== undefined) {
            ...
            for (const textPath of textPathGeometries) {
                ...
                const textElement = textElementBuilder
                    ...
                    .build(textPath.text, path, tile.offset, tile.dataSource.name, textPath.objInfos, textPath.pathLengthSqr);
        ...
        if (decodedTile.textGeometries !== undefined) {
            for (const text of decodedTile.textGeometries) {
                ...
                for (let i = 0; i < numPositions; ++i) {
                    ...
                    const textElement = textElementBuilder.build(label, point, tile.offset, tile.dataSource.name, attributes);
                    tile.addTextElement(textElement);
                }
            }
        }
