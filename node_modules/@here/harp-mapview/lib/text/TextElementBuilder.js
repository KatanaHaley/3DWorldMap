...
class TextElementBuilder {
     ...
     */
    build(text, points, tileOffset, dataSourceName, attributes, pathLengthSqr, offsetDirection) {
        var _a;
        ...
        const textElement = new TextElement_1.TextElement(harp_text_canvas_1.ContextualArabicConverter.instance.convert(text), points, renderStyle, layoutStyle, this.m_priority, this.m_xOffset, this.m_yOffset, featureId, technique.style, this.m_fadeNear, this.m_fadeFar, tileOffset, offsetDirection, dataSourceName);
