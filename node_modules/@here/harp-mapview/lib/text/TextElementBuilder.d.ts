...
export declare class TextElementBuilder {
     ...
     */
    build(text: string, points: THREE.Vector3 | THREE.Vector3[], tileOffset: number, dataSourceName: string, attributes?: AttributeMap, pathLengthSqr?: number, offsetDirection?: number): TextElement;
