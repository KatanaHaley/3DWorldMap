...
class PoiManager {
    ...
    addLineMarker(poiBuilder, tile, poiGeometry, positions, worldOffsetX) {
        ...
        const textElement = poiBuilder
            ...
            .build(text, positionArray, tile.offset, tile.dataSource.name, getAttributes(poiGeometry));
    ...
    addPoi(poiBuilder, tile, poiGeometry, positions, worldOffsetX) {
        ...
        for (let i = 0; i < positions.count; ++i) {
            ...
            const textElement = poiBuilder
                ...
                .build(getText(poiGeometry, i), getPosition(positions, worldOffsetX, i), tile.offset, tile.dataSource.name, getAttributes(poiGeometry, i), undefined, offsetDirection);
            tile.addTextElement(textElement);
        }
    }
}
