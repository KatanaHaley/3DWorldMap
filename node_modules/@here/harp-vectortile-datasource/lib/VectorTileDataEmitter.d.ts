...
export declare class VectorTileDataEmitter {
    ...
    constructor(m_decodeInfo: DecodeInfo, m_styleSetEvaluator: StyleSetEvaluator, m_gatherFeatureAttributes: boolean, m_skipShortLabels: boolean, m_enableElevationOverlay: boolean, m_languages?: string[] | undefined);
