...
function addHarpWebpackConfig(config, harpConfig) {
    ...
    const WebpackMergeMatchLoader = webpack_merge_1.mergeWithRules({
        module: {
            rules: {
    ...
    const mainConfig = (mainEntry === null || mainEntry === void 0 ? void 0 : mainEntry.match(/\.tsx?$/)) ? WebpackMergeMatchLoader(baseConfig, typescriptConfig)
        : baseConfig;
    const bundles = [
        WebpackMergeMatchLoader(Object.assign(Object.assign({}, mainConfig), { plugins: createPlugins(harpConfig === undefined ? undefined : harpConfig.htmlTemplate), stats: {
                all: false,
                timings: true,
                exclude: "resources/",
                errors: true,
    ...
    if (harpConfig !== undefined && harpConfig.decoderEntry !== undefined) {
        const decoderConfig = harpConfig.decoderEntry.endsWith(".ts")
            ...
            : baseConfig;
        bundles.push(WebpackMergeMatchLoader(Object.assign({ target: "webworker", entry: {
